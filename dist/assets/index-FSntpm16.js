...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Tn,depthTest:!1,depthWrite:!1})}function To(){return new Wn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:na(),fragmentShader:`
...
#define LOW_PRECISION`),e}function Qp(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===gc?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===pl?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===on&&(e="SHADOWMAP_TYPE_VSM"),e}function em(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case gi:case _i:e="ENVMAP_TYPE_CUBE";break;case Hr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function tm(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case _i:e="ENVMAP_MODE_REFRACTION";break}return e}function nm(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case _c:e="ENVMAP_BLENDING_MULTIPLY";break;case Bl:e="ENVMAP_BLENDING_MIX";break;case Hl:e="ENVMAP_BLENDING_ADD";break}return e}function im(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function rm(r,e,t,n){const i=r.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Qp(t),l=em(t),u=tm(t),h=nm(t),d=im(t),m=t.isWebGL2?"":Xp(t),g=qp(s),_=i.createProgram();let p,f,T=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Gi).join(`
`)),a=Ws(a),a=Uo(a,t),a=No(a,t),o=Ws(o),o=Uo(o,t),o=No(o,t),a=Oo(a),o=Oo(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(T=`#version 300 es
