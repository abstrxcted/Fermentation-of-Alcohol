...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Tn,depthTest:!1,depthWrite:!1})}function vo(){return new Vn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Qs(),fragmentShader:`
		...
		`,blending:Tn,depthTest:!1,depthWrite:!1})}function Mo(){return new Vn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qs(),fragmentShader:`
...
`].filter(Hi).join(`
`)),a=Gs(a),a=Co(a,t),a=Lo(a,t),o=Gs(o),o=Co(o,t),o=Lo(o,t),a=Po(a),o=Po(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(T=`#version 300 es
